...
class StitchbookMigrationTest {
    ...
    fun migrationFromOneToTwoPreservesProjectsAndCreatesGuideSchema() =
        runBlocking {
            // MIGRATION_3_4/MIGRATION_4_5/MIGRATION_5_6/MIGRATION_6_7/MIGRATION_7_8/MIGRATION_8_9/MIGRATION_9_10/MIGRATION_10_11 must be included even
            // though this test is only about the 1->2 step: Room always
            // migrates up to the version declared on @Database (now 11), so
    ...
    fun migrationFromTwoToThreePreservesGuideDataAndCreatesExecutionSchema() =
        runBlocking {
            ...
            val expectedTables = setOf(
                ...
                "library_items", "stash_items", "tool_sets", "tool_items", "counters",
                "counter_notes"
            )
