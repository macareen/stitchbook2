...
- No deterministic section/row/repeat parsing, size selection, or Draft-editor mapping exists yet -- those are separate, later increments of the same parser foundation.
