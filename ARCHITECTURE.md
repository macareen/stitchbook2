...
- `ParsedPattern` is not yet mapped into a `GuideDraft`, and there is no UI entry point -- both are later increments of the same parser foundation, along with size selection and OCR fallback.
